...
fn build(l: &mut Loader) {
    ...
    item! { BasicBorderRectangle: Rectangle {
        ...
        /// The shape of the border radius corners. This single value is applied to all four corners.
        /// \default CornerShape.round
        in property <CornerShape> border-corner-shape;
    } }
    ...
    item! { BorderRectangle: BasicBorderRectangle {
        ...
        in property <CornerShape> border-top-left-corner-shape;
        ///
        in property <length> border-top-right-radius;
        in property <CornerShape> border-top-right-corner-shape;
        ///
        in property <length> border-bottom-left-radius;
        in property <CornerShape> border-bottom-left-corner-shape;
        ///
        in property <length> border-bottom-right-radius;
        in property <CornerShape> border-bottom-right-corner-shape;
        //! ## Drop Shadows
        //!
